...
export default class LocationsDetails extends React.Component {
  ...
  //             return (currentId === res.data[i].warehouseId)
  //           })
      ...
      <div className="locations-details">
        {
          Object.keys(this.state.warehouse).length > 0 && this.state.warehouse.constructor === Object ?
            <section className="details-container" key={`warehouse-${this.state.warehouse.id}`}>
