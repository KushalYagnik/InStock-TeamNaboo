...
//   Post added here so each separate piece can work individually
  ...
  return (
      ...
      <Modal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)}> 
            <form action="" onSubmit={sendUpload}>
            ...
            <input className="modalW__form--input" onChange={(e) => setName(e.target.value)} name="Warehouse" placeholder="Name and ID"/>
